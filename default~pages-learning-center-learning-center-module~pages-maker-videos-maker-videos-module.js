(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-learning-center-learning-center-module~pages-maker-videos-maker-videos-module"],{
...
/***/ "m+tC":
/*!********************************************************************!*\
  !*** ./src/app/pages/maker-videos/maker-video-resolver.service.ts ***!
  \********************************************************************/
/*! exports provided: getVideoImageSource, toMakerVideo, MakerVideoResolverService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getVideoImageSource", function() { return getVideoImageSource; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toMakerVideo", function() { return toMakerVideo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MakerVideoResolverService", function() { return MakerVideoResolverService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "EM62");
...
const getVideoImageSource = (video, directory = '') => {
    ...
    if (video.image) {
        result = video.image;
        if (!Object(_constants_utils__WEBPACK_IMPORTED_MODULE_2__["isHttp"])(video.image)) {
...
class MakerVideoResolverService {
    ...
    getResult(mdPath) {
        return this.contentService.getContent(mdPath).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((item) => toMakerVideo(item)));
    }
}
MakerVideoResolverService.ɵfac = function MakerVideoResolverService_Factory(t) { return new (t || MakerVideoResolverService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_shared_services_content_service__WEBPACK_IMPORTED_MODULE_3__["ContentService"])); };
MakerVideoResolverService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: MakerVideoResolverService, factory: MakerVideoResolverService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MakerVideoResolverService, [{
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "EM62");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "0Wlh");
/* harmony import */ var _maker_video_resolver_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./maker-video-resolver.service */ "m+tC");
/* harmony import */ var _shared_services_content_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/services/content.service */ "qc/9");
...
class MakerVideosResolverService {
    ...
    resolve(route) {
        ...
        return this.content.getIndex('app-maker-videos').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((items) => {
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((makerVideos) => {
            return makerVideos.map(item => Object(_maker_video_resolver_service__WEBPACK_IMPORTED_MODULE_2__["toMakerVideo"])(item, this.directory));
        }));
    }
}
...
//# sourceMappingURL=default~pages-learning-center-learning-center-module~pages-maker-videos-maker-videos-module.js.map