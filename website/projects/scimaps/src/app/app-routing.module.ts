...
const routes: Routes = [
  ...
  { path: 'map', loadChildren: () => import('./pages/map/map.module').then(m => m.MapModule), data: { animation: 'Map', type: 'map'}},
  { path: 'macroscope', loadChildren: () => import('./pages/macroscope/macroscope.module').then(m => m.MacroscopeModule),  data: { animation: 'Macroscope', type: 'macroscope'} },
